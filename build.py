...
def main():
    ...
    # Sitemap
    sitemap_urls = ['<url><loc>https://raingor.github.io/longzu/</loc></url>']
    for book in books:
        sitemap_urls.append(f'<url><loc>https://raingor.github.io/longzu/{book["slug"]}/</loc></url>')
        for ch in book['chapters']:
            sitemap_urls.append(f'<url><loc>https://raingor.github.io/longzu/{book["slug"]}/{ch["slug"]}.html</loc></url>')
